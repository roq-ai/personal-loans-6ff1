...
import { getLoanApplicationById } from 'apiSdk/loan-applications';
import { LoanApplicationInterface } from 'interfaces/loan-application';

function LoanApplicationViewPage() {
              ...
              >
                ...
                {hasAccess('cashback_offer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/cashback-offers/view/${data?.cashback_offer?.id}`}>
                        {data?.cashback_offer?.offer_details}
                      </Link>
                    }
                  />
                )}
