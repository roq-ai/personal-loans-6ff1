...
import { getCashbackOfferById } from 'apiSdk/cashback-offers';
import { CashbackOfferInterface } from 'interfaces/cashback-offer';
import { LoanApplicationListPage } from 'pages/loan-applications';

function CashbackOfferViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Offer Details" text={data?.offer_details} />
